...
2. **Vercel** — le projet `novalis` (servi sur `boulevard-victor-hugo.vercel.app` : l'auto-domaine
   `novalis.vercel.app` est pris par un tiers) doit être lié à ce repo pour
